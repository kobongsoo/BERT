...
|소스명|설명|기타|
|:-----------------|:-----------------------------------------------------------|:---------------------|
|[distilbert-MLM-Trainer-V1.2](https://github.com/kobongsoo/BERT/blob/master/distilbert/distilbert-MLM-Trainer-V1.2.ipynb)|**DistilBERT를 Trainer로 Further MLM 훈련시키는 예제** |**load_dataset** 사용, **데이터 로딩 및 훈련시간이 감소됨**|
