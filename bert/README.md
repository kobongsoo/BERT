## BERT 예제 <img src="https://img.shields.io/badge/Pytorch-EE4C2C?style=flat-square&logo=Pytorch&logoColor=white"/><img src="https://img.shields.io/badge/Python-3766AB?style=flat-square&logo=Python&logoColor=white"/></a>
...
|[bert/bert-NSP-MLM-Trainer-V2.0.ipynb](https://github.com/kobongsoo/BERT/blob/master/bert/bert-NSP-MLM-Trainer-V2.0.ipynb)|**처음부터 NSP+MLM 훈련** 하거나 혹은 기존 훈련된 BERT에, **추가 NSP+MLM 훈련** 시키는 예제| 훈련은 **HuggingFace Trainer를 이용**함, **load_dataset 이용**, **속도향상**|
